...
- [ ] Set Root Directory to `savor-site/`
- [ ] Verify Framework preset detects "Astro"
- [ ] Add environment variable: `WORDPRESS_API=https://savorcms.wordpress.com/wp-json/wp/v2`
- [ ] Deploy and test landing page on Vercel URL

**Success Criteria**: Landing page live on Vercel with correct URL
...
#### Subtasks:
- [ ] Sign up for WordPress.com Business plan
- [ ] Set domain to `savorcms.wordpress.com`
- [ ] Configure Settings → General → Title: "Savor CMS"
- [ ] Set Settings → Reading → Site visibility to Public
- [ ] Uncheck "Discourage search engines"
- [ ] Install Rank Math SEO plugin
- [ ] Install Classic Editor plugin (optional)
- [ ] Install WPGraphQL plugin (optional)
...
#### Subtasks:
- [ ] Create `savor-site/src/lib/` directory
- [ ] Create `wordpress.ts` file with TypeScript interfaces
- [ ] Implement `getPosts()` function with error handling
- [ ] Implement `getPostBySlug()` function
- [ ] Implement `getCategories()` function
- [ ] Add proper TypeScript types for WordPressPost interface
- [ ] Test API client functions

**Success Criteria**: API client created with proper error handling and TypeScript support
...
1. **Complete Phase 1** - Technical Foundation (All 5 tasks)
2. **Start Task 2.1** - WordPress authentication and basic scripting
3. **Set up monitoring** - Basic GA4 and GSC (Task 4.1)
